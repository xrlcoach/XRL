  ...
  <article>
    <router-link v-if="fixture" :to="fixtureLink" class="fixture-preview">
      <div>
        <p>
          <img
            :src="`https://raw.githubusercontent.com/xrlcoach/XRL/main/src/assets/${fixture?.home}.png`"
            :height="100"
            :width="100"
          />
        </p>
      ...
      <div>
        <p>
          <img
            :src="`https://raw.githubusercontent.com/xrlcoach/XRL/main/src/assets/${fixture?.away}.png`"
            :height="100"
            :width="100"
          />
        </p>
